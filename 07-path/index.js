...
const filePath = '/Users/hanna/Desktop/node/index.js';
const textFilePath = '/Users/hanna/Desktop/file.txt';
...
console.log(path.dirname(filePath)); // /Users/hanna/Desktop/node
console.log(path.dirname(directoryPath)); // ./node

console.log(path.resolve(relativePath)); // c:\Users\zinai\OneDrive\Рабочий стол\Bogdan Stashchuk\node-bogdan-stashchuk\07-path\node\movie.mov
